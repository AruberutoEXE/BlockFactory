    ...
    <div class="container">   
        <div class="card-group ">
            ...
            <div class="card  border-dark bg-light">
                ...
                <img class="card-img-top m-1"  style="max-width:90%;" src="{{ asset('img/' . $producto->id . '.png') }}" alt="Card image cap">  
            ...
            <div class="card  border-dark bg-light">
                        ...
                        <div class="float-right m-1">
                            <a class="btn btn-primary" style="margin-left:0.5%" href="{{ route('productos.index') }}"> Atrás</a>
                        </div>
                        
                        <div class="float-right m-1">
                       
                            <a class="btn btn-primary" style="margin-left:0.5%" href="{{ route('carro.add',$producto->id) }}"><i class="fa fa-fw fa-eye"></i> Añadir al carrito</a>
                        </div>
